...
$auth_users = array(
    'savas' => '$2y$10$HxIUbn7MEftBV.Pd3Bi/MONfMJMPec8gt3BHo7uP.IOIFdfJvS52m', //admin@123
);
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('js/translation.json');
        if($content !== FALSE) {
...
<head>
    ...
    <meta name="author" content="Laura Po">
